...
const gifts = [
  { id: 1, name: "Licença para Roncar (Finais de Semana)", price: 100 },
  { id: 2, name: "Bagels em Nova York", price: 100 },
  { id: 3, name: "Edredom Fofinho", price: 280 },
  { id: 4, name: "Fritadeira Elétrica (Airfryer)", price: 400 },
  { id: 5, name: "Curso de 'Como dobrar lençol de elástico'", price: 100 },
  { id: 6, name: "Mixer de Mão", price: 180 },
  { id: 7, name: "Negociador de Canal de TV", price: 200 },
  { id: 8, name: "Toalhas de Banho Gigantes", price: 200 },
  { id: 9, name: "Spotify sem anúncios na lua de mel", price: 100 },
  { id: 10, name: "Passeio de Gôndola em Veneza", price: 420 },
  { id: 11, name: "Pílulas de 'Sim, querida'", price: 100 },
  { id: 12, name: "Croissant aos pés da Torre Eiffel", price: 100 },
  { id: 13, name: "Vale 'Hoje a Louça é Sua'", price: 100 },
  { id: 14, name: "Passe livre para jogar videogame", price: 100 },
  { id: 15, name: "Treinamento Ninja para sair da Cama", price: 110 },
  { id: 16, name: "Cadeira de Escritório", price: 800 },
  { id: 17, name: "Curso de 'Ouvir sem dar solução'", price: 100 },
  { id: 18, name: "Curso de como usar a máquina de lavar", price: 100 },
  { id: 19, name: "Passeio de camelo no Egito", price: 250 },
  { id: 20, name: "Controle remoto universal", price: 100 },
  { id: 21, name: "Alvará de Soltura para Bar com Amigos", price: 150 },
  { id: 22, name: "Aula de culinária básica", price: 180 },
  { id: 23, name: "Micro-ondas", price: 600 },
  { id: 24, name: "Ingressos para o cinema (filme dele)", price: 100 },
  { id: 25, name: "Kit Desarmamento de Bomba (TPM)", price: 180 },
  { id: 26, name: "Panela de Pressão Elétrica", price: 400 },
  { id: 27, name: "Fundo para multas de trânsito", price: 100 },
  { id: 28, name: "Lava-Louças", price: 3000 },
  { id: 29, name: "Taxa de Proteção contra Spoilers", price: 120 },
  { id: 30, name: "Liquidificador Potente", price: 280 },
  { id: 31, name: "Purificador de Água", price: 800 },
  { id: 32, name: "Fogão 5 bocas", price: 1200 },
  { id: 33, name: "Abajur Moderno", price: 180 },
  { id: 34, name: "Kit Ressaca Pós-Festa", price: 100 },
  { id: 35, name: "Detector de Sarcasmo", price: 350 },
  { id: 36, name: "Vinho no Vale do Napa", price: 320 },
  { id: 37, name: "Churrasqueira Elétrica", price: 280 },
  { id: 38, name: "Safari na África do Sul", price: 850 },
  { id: 39, name: "Café infinito", price: 100 },
  { id: 40, name: "Vale 'Jantar sem celular'", price: 130 },
  { id: 41, name: "Adega Climatizada", price: 1500 },
  ...
  { id: 46, name: "Geladeira Moderna", price: 3500 },
  { id: 47, name: "Kit Anti-Gelo nos Pés", price: 100 },
  { id: 48, name: "Personal Stylist para Pijamas", price: 120 },
  { id: 49, name: "Botão de 'Mudo'", price: 100 },
  { id: 50, name: "Robô Aspirador", price: 2000 },
  { id: 51, name: "Aurora Boreal na Islândia", price: 900 },
  { id: 52, name: "Café da manhã flutuante em Bali", price: 280 },
  { id: 53, name: "Curso de Orientação no Shopping", price: 100 },
  { id: 54, name: "Smart TV 55\"", price: 3000 },
  { id: 55, name: "Travesseiros Nasa", price: 160 },
  { id: 56, name: "Jogo de Panelas", price: 500 },
  ...
  { id: 60, name: "Ventilador Turbo", price: 250 },
  { id: 61, name: "Batedeira Planetária", price: 1200 },
  ...
  { id: 65, name: "Troféu 'Você Estava Certo(a)'", price: 100 },
  ...
  { id: 69, name: "Manual 'Como elogiar a comida da sogra'", price: 100 },
  ...
  { id: 73, name: "Bússola para Homem que Não Pede Informação", price: 100 },
  { id: 74, name: "Curso de Leitura de Mente Nível 1", price: 2500 },
  { id: 75, name: "Gelato em Roma", price: 100 },
  { id: 76, name: "Ferro de Passar a Vapor", price: 200 },
  ...
  { id: 84, name: "Paciência (Vendida separadamente)", price: 100 },
  { id: 85, name: "Conjunto de Tupperware", price: 220 },
  { id: 86, name: "Torradeira", price: 150 },
  { id: 87, name: "Veto Presidencial para Visitas Surpresa", price: 100 },
  { id: 88, name: "Fundo para o 'Eu avisei'", price: 100 },
  { id: 89, name: "Aspirador de Pó Vertical", price: 500 },
  { id: 90, name: "Taxa de Reembolso por Piada Ruim", price: 100 },
  { id: 91, name: "Suplemento de Paciência para TPM", price: 150 },
  { id: 92, name: "Cafeteira Expresso", price: 800 },
  { id: 93, name: "Placa 'Proibido Opinar na Decoração'", price: 100 },
  { id: 94, name: "Máquina de Lavar", price: 2500 },
  ...
  { id: 100, name: "Sanduicheira Grill", price: 150 },
];
